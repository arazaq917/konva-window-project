...
function App() {
    ...
    layer.on('dragmove', function (e) {
        ...
        console.log("running intersection")
    ...
    function createInfo(frameWidth, frameHeight) {
      console.log("creating agian", frameWidth, frameHeight);
        ...
        group.add(lines,bottomArrow,leftArrow, leftLabel, bottomLabel);
        return group;
    }
    ...
    const createFrame = (frameWidth, frameHeight) => {
        ...
        let tr = new Konva.Transformer({
            ...
            boundBoxFunc: function (oldBoundBox, newBoundBox) {
                // console.log("groupHeight",group.getClientRect())
                groupHeight = group.getClientRect().height
                groupWidth = group.getClientRect().width
                createInfo(groupWidth,groupHeight)
                layer.draw();
